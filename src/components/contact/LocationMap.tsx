...
export default function LocationMap() {
  return (
    <motion.div
      ...
      className="mb-16"
    >
      <h2 className="text-4xl font-bold text-nga-navy mb-8 text-center">
        Find <span className="text-nga-green">Us</span>
      </h2>

      <div className="rounded-2xl overflow-hidden shadow-2xl border-2 border-[#a8cf45]/30">
        <iframe
